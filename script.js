...
container.innerHTML = `
<input id="display" placeholder="Let's do it!  ">
<div class="nbutton">
    ...
    button.addEventListener ('click',(e) => {
        switch(e.target.innerText){
            ...
            case "MS":
                ...
                break
            case "M+":
                r=window.localStorage.getItem('store')
                window.localStorage.setItem('store',Number(r)+Number(display.value))
                display.value=window.localStorage.getItem
                break
            case "M-":
                r=window.localStorage.getItem('store')
                window.localStorage.setItem('store',Number(r)-Number(display.value))
...
instruction.setAttribute('class','note')
